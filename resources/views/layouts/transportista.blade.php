...
<head>
  <title>efletex - @yield('titulo')</title>
...
$cuentaVerificada=false;
   if (Auth::check()) {
          ...
          $cuentaVerificada=Auth::user()->verifiedaccount;
           $dataPerson=Udoktor\Person::find($idPerson);
        ...
        <div class="navbar">
            <div class="container">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-brand-image" href="/transportista">
              ...
              <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav noticebar navbar-left" id="menuNotifiacionesCabecera"></ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown navbar-profile">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:;">
                      ...
                      <li>
                        <a href="{!! url('/transportista/estadoCuenta') !!}">
                          <i class="fa fa-dollar"></i>
                          &nbsp;&nbsp;<font class="flet-lab">{{trans("leng.Estado de cuenta")}}</font>
                        </a>
                      </li>
                      <li>
                        <a href="{!! url('/logout') !!}">
            ...
            ?>
                              ...
                              <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a href="/bandejaEntrada">{{ trans('leng.Mensajes recibidos') }}</a></li>
                                  <li><a href="/bandejaSalida">{{ trans('leng.Mensajes enviados') }}</a></li>
                                </ul>
                              </li>
                              ...
                              <li class="dropdown">
                                <a href="#about" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                  <li><a href="{{ url('transportista/mis-envios') }}">{{ trans('leng.Mis Cargas') }}</a></li>
                                  <li><a href="/transportista/ofertas">{{ trans('leng.Buscar Cargas') }}</a></li>
                                </ul>

                              </li>

                              <li class="">
                                  <a href="/transportista/misofertas"><i class="fa fa-gavel"></i>{{ trans('leng.Mis Ofertas') }}</a></li>
                              </li>

                                    
                                <li class="">
                                    <a href="{{ url('transportista/mis-calificaciones') }}">
                                      <i class="fa fa-star"></i>{{ trans('leng.misCalificaciones') }}</a>
                                </li>
                                ...
                                <a href="/misPreguntas">
                                  ...
                                  {{ trans('leng.Mis preguntas') }}
                                </a>
                              </li>
                              
                              <li class="">
                                <a href="{!! url('/transportista/misGrupos')!!}">
                                  <i class="fa fa-group"></i>
                                  {{ trans('leng.Mis grupos') }}
                                </a>
                              </li>

                              <li class="">
                                <a href="{!! url('/transportista/tracking')!!}">
                              ...
                              <li class="dropdown">
                                <a href="#about" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
                                  <i class="fa fa-truck"></i>
                                  {{ trans('leng.Mis vehículos') }}
                                  <span class="caret"></span>
                                </a>

                                  <ul class="dropdown-menu">
                                  <li><a href="{{ url('transportista/misVehiculos') }}">{{ trans('leng.Mis vehículos') }}</a></li>
                                  <li><a href="{{ url('transportista/misChoferes') }}">{{ trans('leng.Mis choferes') }}</a></li>
                                </ul>
    ...
    <div class="container">
        ...
        <div class="content">
          ...
          <div id="contenidoPaginaLay" class="content-container">
              <?php if($cuentaVerificada==false){?>
              <div class="alert alert-danger">
                <strong>{{trans("leng.Cuenta no verificada")}}!</strong>&nbsp;{{trans("leng.para poder ofertar, hacer preguntas, etc. espere a que el administrador verifique su cuenta")}}.
              </div>
             <?php } ?>
              @section('contenido')
              @show
...
{!!Html::script('Theme/js/libs/bootstrap.min.js')!!}
  ...
  {!!Html::script('js/generalTransportista.js')!!}
