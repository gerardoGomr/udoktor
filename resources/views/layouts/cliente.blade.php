...
$cuentaVerificada=false;
   if (Auth::check()) {
          ...
          $cuentaVerificada=Auth::user()->verifiedaccount;
           $dataV_person=Udoktor\V_person::find($idV_person);
           $dataUsers=Udoktor\User::where("personid","=",$idV_person)->get();

           if($dataV_person->company==""){
              $nombreLogueado=  ucwords($dataV_person->fullname);
           }else{
              $nombreLogueado= strlen($dataV_person->company)>30?substr(ucwords($dataV_person->company),0,27)."...":$dataV_person->company;
           }
           ...
           $imagenUsuario="";
           if(trim($dataV_person->img)==""){ 
               $imagenUsuario=asset("img/logousuario.png");
           }else{ 
               $imagenUsuario=asset($dataV_person->img);
        ...
        <div class="navbar">
            <div class="container">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-brand-image" href="/cliente">
              ...
              <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav noticebar navbar-left" id="menuNotifiacionesCliente">
                    <li class='dropdown'>
         ...
         <?php  if (Auth::check()) {
                  ...
                  ?>
                            <li class="">
                              ...
                              <li class="">
                                <a href="/cliente/servicios">
                                  <i class="fa fa-stethoscope"></i>
                                  {{ trans('leng.Buscar servicios') }}
                                </a>
                              </li>
                              
                              <li class="">
                                <a href="/cliente/misCitas">
                                  <i class="fa fa-calendar"></i>
                                  {{ trans('leng.Mis citas') }}
                                </a>
                              </li>
         <?php
          ...
          <div id="contenidoPaginaLay" class="content-container">
             <?php if($cuentaVerificada==false){?>
              <div class="alert alert-danger">
                <strong>{{trans("leng.Cuenta no verificada")}}!</strong>&nbsp;{{trans("leng.para poder publicar envios espere a que el administrador verifique su cuenta")}}.
              </div>
             <?php } ?>
              @section('contenido')
              @show
...
{!!Html::script('Theme/js/libs/bootstrap.min.js')!!}
  ...
  {!!Html::script('js/cliente/notificaciones.js')!!}
