...
@section('contenido')
    ...
    <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                   <label class="checkbox-inline">
                      <input type="checkbox" id="respondidas"><b> {{ trans('leng.Sin responder') }}</b>
                   </label>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button"  class="btn btn-primary btn-sm" onclick="buscarPreguntasCliente();"><i class="fa fa-search"></i>&nbsp;{{ trans('leng.Buscar')}}</button>
                <button type="button" class="btn btn-primary btn-sm" onclick="restablecerFiltrosPreguntaCliente();"><i class="fa fa-refresh"></i>&nbsp;{{ trans('leng.Reestablecer')}}</button>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table id="listaPreguntasGeneral" class="table table-striped table-bordered table-hover table-highlight table-checkable" style="width: 100%">
                    <thead>
                        <tr>
                            <th style="width: 23%">{{ trans("leng.Transportista")}}</th>
...
@section('otrosScripts')
    {!!Html::script('js/misPreguntasCliente.js')!!}  
@endsection
