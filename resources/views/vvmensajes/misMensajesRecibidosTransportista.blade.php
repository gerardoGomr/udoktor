...
@section('contenido')
    ...
    <h2 class="heading content-header-title">{{ trans('leng.Mensajes recibidos') }}</h2>
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-5">
                <label>{{ trans('leng.Emisor, mensaje')}}.</label>
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                   <label class="checkbox-inline">
                      <input type="checkbox" id="sinleer"><b> {{ trans('leng.No leídos') }}</b>
                   </label>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button"  class="btn btn-primary btn-sm" onclick="buscarMenajes();"><i class="fa fa-search"></i>&nbsp;{{ trans('leng.Buscar')}}</button>
                <button type="button" class="btn btn-primary btn-sm" onclick="restablecerFiltrosMensajes();"><i class="fa fa-refresh"></i>&nbsp;{{ trans('leng.Reestablecer')}}</button>
            </div>
        </div>
       ...
       <div class="col-md-12">
        <div class="col-md-12">
            <div class="table-responsive">
                <table id="listaMensajesGeneral" class="table table-striped table-bordered table-hover table-highlight table-checkable" style="width: 100%">
                    <thead>
                        <tr>
                            <th style="width: 25%">{{ trans("leng.Emisor")}}</th>
...
@section('otrosScripts')
    {!!Html::script('js/misMensajesRecibidos.js')!!}  
@endsection
