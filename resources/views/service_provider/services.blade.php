        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="body table-responsive" id="services">
                    @include('service_provider.services_list')
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        @foreach($services as $service)
                                            <input type="checkbox" name="services[]" id="service_{{ $service->getId() }}" class="filled-in" value="{{ $service->getId() }}">
                                            <label for="service_{{ $service->getId() }}">&nbsp; {{ $service->getName() }}</label>
                                            <br>
                                        @endforeach
                                    </div>
                                </div>
