...
?>
<br>
<input type="hidden" value="{{$idCita}}" id="idCita">
...
<div class="row" style="font-size: 0.9em">
   <div class="col-sm-12">
       <div class="col-sm-12">
        <button type="button" onclick="guardaRechazoCita();" style="width: 110px;" class="btn btn-success btn-sm"><i class="fa fa-check-circle"></i>&nbsp;{{trans("leng.Guardar")}}</button>
