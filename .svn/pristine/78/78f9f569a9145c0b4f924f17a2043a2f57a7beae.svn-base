...
@section('contenido')
    ...
    <div class="col-md-12" style="font-size: 0.9em">
        <div class="row">
            <div class="col-md-6">
                <label>{{ trans('leng.Compañia, cliente, hora')}}.</label>
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                   ...
                   <label class="checkbox-inline">
                    ...
                    <label class="checkbox-inline">
                      <input type="checkbox" id="cancelada"> {{ trans('leng.Cancelada') }}
                   </label>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button"  class="btn btn-primary btn-sm" onclick="buscarCitasPrestador();"><i class="fa fa-search"></i>&nbsp;{{ trans('leng.Buscar')}}</button>
                <button type="button" class="btn btn-primary btn-sm" onclick="restablecerFiltrosCitaPrestador();"><i class="fa fa-refresh"></i>&nbsp;{{ trans('leng.Reestablecer')}}</button>
            </div>
        </div>
    </div>       
        ...
        <div class="col-md-12">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table id="listaCitasPrestador" class="table table-striped table-bordered table-hover table-highlight table-checkable" style="width: 100%">
                        <thead>
                            <tr>
                                <th style="width: 25%">{{ trans("leng.Compañia / Cliente")}}</th>
                                <th style="width: 32%">{{ trans("leng.Servicios / Domicilio")}}</th>
                                <th style="width: 12%">{{ trans("leng.Fecha")}}</th>
                                <th style="width: 10%">{{ trans("leng.Hora")}}</th>
                                <th style="width: 11%">{{ trans("leng.Estado")}}</th>
...
@section('otrosScripts')
    {!!Html::script('js/prestadorServicio/misCitas.js')!!}  
@endsection
